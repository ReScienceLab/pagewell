...
Playbooks preserve detailed instructions behind the compact Pagewell router skill.
...
```txt
page-types/product.md
page-types/use-case.md
page-types/faq.md
page-types/glossary.md
page-types/alternative.md
page-types/docs.md
page-types/lp.md
