...
4. Run `references/skills/plan-topic-cluster.md`.
5. Generate only the highest-signal pages first with `references/skills/generate-page.md` or `references/skills/generate-free-tool.md`.
6. Run `references/skills/seo-ops.md` internal-link mode.
7. Monitor with `references/skills/seo-ops.md` maintenance mode.
